...
@section('content')
  <div class="col-12 d-flex flex-column flex-md-row px-0">
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 offcanvas-lg offcanvas-start p-3" id="sidebar" >
      ...
      <a class="sidebar_profile rounded-pill d-flex align-items-center p-2 mb-4 mt-auto" href="{{ route('logistic_profile') }}">
    ...
    <div class="bg-white flex-fill">
      ...
      <div class="p-4">
        @yield('logistic_content')
      </div>  
    </div>
  </div>

  @yield('logistic_complement')
@endsection
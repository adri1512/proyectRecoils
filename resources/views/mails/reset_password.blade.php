...
<body>
    <span style="display:none; max-height:0; max-width:0; opacity:0; overflow:hidden;">
        Restablece tu contraseña de Recoils de forma segura.
    </span>
        ...
        <div class="card-container" style="max-width: 600px; width: 100%; margin: 0 auto;">
            <div class="card" style="background-color: #ffffff; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1); padding: 30px; text-align: center;">
                ...
                <div class="header-container" style="display: flex; align-items: center; justify-content: center; gap: 10px; margin-bottom: 15px;">
                    <img src="{{ $message->embed($pathToImage) }}" alt="Logo" class="logo" style="width: 60px; height: auto;">
                ...
                <div class="content-section" style="margin: 15px 0;">
                    <p style="color: #333; margin-bottom: 20px;">Para restablecer tu contraseña haz click en el siguiente botón:</p>
                </div>
                
                <!-- Botón -->
                <div class="content-section" style="margin: 15px 0;">
                    <a href="{{ route('user_password_reset', ['email' => $email, 'token' => $token])}}" class="button" style="display: inline-block; padding: 12px 24px; background-color: #007BFF; color: #ffffff; text-decoration: none; font-size: 18px; font-weight: bold; border-radius: 6px;">Restablecer Contraseña</a>
                </div>
                ...
                <div class="content-section" style="margin: 15px 0;">
                    <p class="link-text" style="color: #333; font-size: 14px; margin: 20px 0 0 0;">
                        ...
                        <a href="{{ route('user_password_reset', ['email' => $email, 'token' => $token]) }}" class="link" style="color: #007BFF; text-decoration: underline;">{{ route('user_password_reset', ['email' => $email, 'token' => $token]) }}</a>
                    </p>
                </div>               
            </div>
        </div>
